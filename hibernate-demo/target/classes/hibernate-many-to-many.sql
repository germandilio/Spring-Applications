DROP SCHEMA IF EXISTS `hibernate-many-to-many`;
CREATE SCHEMA `hibernate-many-to-many`;

USE `hibernate-many-to-many`;
...
CREATE TABLE `course_student` (
    ...
    CONSTRAINT `FK_COURSE_JOIN` FOREIGN KEY (`course_id`)
        REFERENCES `course` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
